...
#define MAX_HYPERCALL_SIZE 3
#define HYPERTREAM_START_NR 900
#define HYPERTREAM_NR 901
#define HYPERTREAM_END_NR 902
        ...
        unsigned long int a0, unsigned long int a1, unsigned long int a2, unsigned long int a3)
{
    ...
    memcpy(buffer, (char*)&a0, sizeof(a0));
    memcpy(buffer+1, (char*)&a1, sizeof(a1));
    memcpy(buffer+2, (char*)&a2, sizeof(a2));
    // memcpy(buffer+3, (char*)&a3, sizeof(a3));
...
int main(int argc, char** argv)
{
    ...
    tic(ts_start);
    delim_hypercall(HYPERTREAM_START_NR, hc_filename);
    while (fgets(buffer, sizeof(buffer), fp)) {
        ...
        // do_hypercall(HYPERTREAM_NR, arg1, arg2, arg3, arg4);
        ...
        // kvm_hypercall_handler(HYPERTREAM_NR, arg1, arg2, arg3, arg4);
        // puts(buffer_output);
        // fprintf(output, buffer_output);
    }
    // end
    delim_hypercall(HYPERTREAM_END_NR, hc_filename);
    toc(ts_end);
