...
# level,time,events
data <- read.table("./io-overhead/data-dd.csv", header=T, sep=",")
...
plot <- ggplot(unique_data, aes(x=reorder(tracing_enabled, t_median), y = t_median)) +
