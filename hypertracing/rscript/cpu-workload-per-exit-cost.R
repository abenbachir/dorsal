...
data <- read.table("./hypertracing/data/cpu-workload-exits-cost2.csv", header=T, sep=",")
...
plot <- ggplot(data_filtered, aes(x=reorder(tracer, total_event_cost), y = total_event_cost)) +
