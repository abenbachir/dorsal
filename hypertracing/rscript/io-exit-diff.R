...
data_10 <- read.table("./hypertracing/data/old/io-exits-10.csv", header=T, sep=",")
data_100 <- read.table("./hypertracing/data/old/io-exits-100.csv", header=T, sep=",")
data_1000 <- read.table("./hypertracing/data/old/io-exits-1000.csv", header=T, sep=",")
data_10000 <- read.table("./hypertracing/data/old/io-exits-10000.csv", header=T, sep=",")
...
data_collected_events <- read.table("./hypertracing/data/old/guest-collected-events.csv", header=T, sep=",")
